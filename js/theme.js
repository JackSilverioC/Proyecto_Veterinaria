        ...
        list.on('updated', function (item) {
          ...
          if (fallback) {
            if (item.matchingItems.length === 0) {
              ...
              paginationButtonNext.classList.add('d-none');
              paginationButtonPrev.classList.add('d-none');
            } else {
              fallback.classList.add('d-none');
              paginationButtonNext.classList.remove('d-none');
              paginationButtonPrev.classList.remove('d-none');
            }
          }
        }); // ---------------------------------------
...
//   var $lineAreaChartEl = document.getElementById('ventas');
//   if ($lineAreaChartEl) {
//     // Get options from data attribute
