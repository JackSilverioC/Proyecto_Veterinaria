        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                if (isset($_POST['add'])) {
                    ...
                    $sql = "insert into pet_type(noTiM,estado)  values (?,?)";

                    $statement = $conex->prepare($sql);

                    $statement->bind_param('si', $noTiM, $estado);
                    ...
                    <div class="card-header">
                        <div class="row flex-between-end">
                            <div class="d-flex col-auto align-self-center mt-2">
                                ...
                                <h5 class="mb-0 mt-1">Registrar Tipo</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                <div class="col-lg-4 mb-3">
                                    ...
                                    <input class="form-control" name="noTiM" required type="text"/>
                                </div>
