    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                $sql_cit = "SELECT quotes.id, veterinarian.id_vet, veterinarian.dnivet, veterinarian.nomvet, veterinarian.apevet, pet_type.id_tiM, pet_type.noTiM, service.id_servi, service.nomser, quotes.title, quotes.nommas, quotes.dueno, quotes.color, quotes.start, quotes.end, quotes.estado FROM quotes INNER JOIN veterinarian ON quotes.id_vet = veterinarian.id_vet INNER JOIN pet_type ON quotes.id_tiM = pet_type.id_tiM INNER JOIN service ON quotes.id_servi = service.id_servi";
                $result_cit = mysqli_query($conex, $sql_cit);
                ?>
                <div class="row g-3 mb-3">
                    <div class="col">
                        <div class="card h-100" id="table" data-list='{"valueNames":["n","dueño","veterinario","cita","mascota","tipo","servicio","inicio","fin","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                        <div class="card-header mt-3 ms-2">
                                <div class="row">
                                    <div class="col-12 align-self-center mb-3">
                                        <h5 class="mb-0">Lista Citas</h5>
                                    </div>
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <a href="reporte_citas.php" target="_blank" class="me-1 btn btn-sm btn-outline border-300" type="button"><span class="bi bi-file-earmark-pdf-fill"></span><span class="d-none d-md-inline ms-1">Reporte</span></a>
                                                ...
                                                <a href="cita_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden">
                                        <thead class="bg-200 text-900">
                                            <tr class="p-0">
                                                ...
                                                <th class="sort" data-sort="veterinario">Veterinario</th>
                                                <th class="sort" data-sort="cita">Cita</th>
                                                <th class="sort" data-sort="mascota">Mascota</th>
                                                <th class="sort" data-sort="tipo">Tipo</th>
                                                <th class="sort" data-sort="servicio">Servicio</th>
                                                <th class="sort" data-sort="inicio">Inicio</th>
                                                <th class="sort" data-sort="fin">Fin</th>
                                        ...
                                        <tbody class="list">
                                            ...
                                            while ($row = mysqli_fetch_array($result_cit)) {
                                            ?>

                                                <tr>
                                                    <td class="n"><?php echo $row['id'];?></td>
                                                    <td class="dueño"><?php echo $row['dueno'];?></td>
                                                    <td class="veterinario"><?php echo $row['nomvet'];?>&nbsp;<?php echo $row['apevet'];?></td>
                                                    <td class="cita"><?php echo $row["title"]; ?></td>
                                                    <td class="mascota"><?php echo $row["nommas"]; ?></td>
                                                    <td class="tipo"><?php echo $row["noTiM"]; ?></td>
                                                    <td class="servicio"><?php echo $row["nomser"]; ?></td>
                                                    <td class="inicio"><?php echo $row["start"]; ?></td>
                                                    <td class="fin"><?php echo $row["end"]; ?></td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="cita_edit.php?idcita=<?php echo $row['id']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#"data-id="<?php echo $row["id"];?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <div class="text-center d-none mb-4" id="pages-table-fallback">
                                    <p class="fw-bold fs-1 mt-3">Cita no encontrada</p>
                                </div>                                
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="cita_delete.php" method="post">
