...
require_once "categorias_delete.php"; ?>
        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                <div class="row g-3 mb-3">
                    <div class="col">
                        <div class="card h-100" id="table" data-list='{"valueNames":["n","nombre","fecha","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                            <div class="card-header mt-2 ms-2">
                                <div class="row">
                                    <div class="col-12 align-self-center mb-3">
                                        <h5 class="mb-0">Lista Categorías</h5>
                                    </div>
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <a href="reporte_categorias.php" target="_blank" class="me-1 btn btn-sm btn-outline border-300" type="button"><span class="bi bi-file-earmark-pdf-fill"></span><span class="d-none d-md-inline ms-1">Reporte</span></a>
                                                ...
                                                <a href="categorias_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden">
                                        ...
                                        <tbody class="list">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td class="n"><?php echo $row["id_cate"]; ?></td>
                                                    <td class="nombre"><?php echo $row['nomcate']; ?></td>
                                                    <td class="fecha"><?php echo $row["fere"]; ?></td>
                                                    <td style="width: 8%;" class="estado"><?php if ($row["estado"] == 1) {
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="categorias_edit.php?idcate=<?php echo $row['id_cate']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#"data-id="<?php echo $row["id_cate"];?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <div class="text-center d-none mb-4" id="pages-table-fallback">
                                    <p class="fw-bold fs-1 mt-3">Categoría no encontrada</p>
                                </div>
