...
require_once "clientes_delete.php"; ?>
        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                <div class="row g-3 mb-3">
                    <div class="col">
                    <div class="card h-100" id="table" data-list='{"valueNames":["n","dni","datos","movil","correo","direccion","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                            <div class="card-header mt-2 ms-2">
                                <div class="row">
                                    ...
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <a href="reporte_clientes.php" target="_blank" class="me-1 btn btn-sm btn-outline border-300" type="button"><span class="bi bi-file-earmark-pdf-fill"></span><span class="d-none d-md-inline ms-1">Reporte</span></a>
                                                ...
                                                <a href="clientes_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden align-middle">
                                        <thead class="bg-200 text-900">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="movil">Móvil</th>
                                        ...
                                        <tbody class="list">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td class="n"><?php echo $row["id_due"]; ?></td>
                                                    <td class="datos">
                                                        <div class="d-flex d-flex align-items-center">
                                                            <div class="avatar avatar-xl me-2">
                                                            <div class="avatar-name rounded-circle"><span><?php  echo $row["nom_due"][0]; echo $row["ape_due"][0]; ?></span></div>
                                                            </div>
                                                            <div class="flex-1">
                                                            <p class="mb-0 fs--1"><?php echo $row["nom_due"] . " " . $row["ape_due"]; ?></p>
                                                            </div>
                                                        </div></td>
                                                        <td class="dni"><?php echo $row["dni_due"]; ?></td>
                                                    <td class="movil"><a href="tel:<?php echo $row["movil"]; ?>"><?php echo $row["movil"]; ?></a></td>
                                                    <td class="correo"><a href="mailto:<?php echo $row["correo"]; ?>"><?php echo $row["correo"]; ?></a></td>
                                                    <td class="direccion"><?php echo $row["direc"]; ?></td>
                                                    <td class="estado"><?php if ($row["estado"] == 1) {
                                                                            ...
                                                                            echo "<span class='badge badge rounded-pill d-block p-1 fs--2 badge-soft-danger'>Inactivo<i class='ms-1 fas fa-ban'></i></span>";
                                                                        } ?></td>
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="clientes_edit.php?idcliente=<?php echo $row['id_due']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#"data-id="<?php echo $row["id_due"];?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <div class="text-center d-none mb-4" id="pages-table-fallback">
                                    <p class="fw-bold fs-1 mt-3">Cliente no encontrado</p>
                                </div>
