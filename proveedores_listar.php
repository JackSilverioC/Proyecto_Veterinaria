...
require_once "proveedores_delete.php"; ?>
        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                <div class="row g-3 mb-3">
                    <div class="col">
                        <div class="card h-100" id="table" data-list='{"valueNames":["n","ruc","nombre","correo","direccion","pais","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                            <div class="card-header mt-3 ms-2">
                                <div class="row">
                                    <div class="col-12 align-self-center mb-3">
                                        <h5 class="mb-0">Lista Proveedores</h5>
                                    </div>
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <a href="reporte_proveedores.php" target="_blank" class="me-1 btn btn-sm btn-outline border-300" type="button"><span class="bi bi-file-earmark-pdf-fill"></span><span class="d-none d-md-inline ms-1">Reporte</span></a>
                                                ...
                                                <a href="proveedores_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden">
                                        <thead class="bg-200 text-900">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="ruc">Ruc</th>
                                                ...
                                                <th class="sort" data-sort="pais">País/Ciudad</th>
                                        ...
                                        <tbody class="list">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td class="n"><?php echo $row["id_prove"]; ?></td>
                                                    <td class="ruc"><?php echo $row["ruc"]; ?></td>
                                                    <td class="nombre"><?php echo $row["nomprove"]; ?></td>
                                                    <td class="correo"><a href="mailto:<?php echo $row["corre"]; ?>"><?php echo $row["corre"]; ?></a></td>
                                                    <td class="direccion"><?php echo $row["direcc"]; ?></td>
                                                    <td class="pais"><?php echo $row["pais"]; ?></td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="proveedores_edit.php?idproveedor=<?php echo $row['id_prove']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#" data-id="<?php echo $row["id_prove"]; ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <div class="text-center d-none mb-4" id="pages-table-fallback">
                                    <p class="fw-bold fs-1 mt-3">Proveedor no encontrado</p>
                                </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="proveedores_delete.php" method="post">
