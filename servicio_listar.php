...
require_once "servicio_delete.php"; ?>
                        ...
                        <div class="card h-100" id="table" data-list='{"valueNames":["n","nombre","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                            <div class="card-header mt-3 ms-2">
                                <div class="row">
                                    <div class="col-12 align-self-center mb-3">
                                        <h5 class="mb-0">Lista Servicios</h5>
                                    </div>
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <a href="servicio_print.php" class="me-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-print"></span><span class="d-none d-md-inline ms-1">Imprimir</span></a>
                                                ...
                                                <a href="servicio_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden">
                                        ...
                                        <tbody class="list">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td class="n"><?php echo $row["id_servi"]; ?></td>
                                                    <td class="nombre"><?php echo $row["nomser"]; ?></td>                                                    
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="servicio_edit.php?idservicio=<?php echo $row['id_servi']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#"data-id="<?php echo $row["id_servi"];?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <div class="text-center d-none mb-4" id="pages-table-fallback">
                                    <p class="fw-bold fs-1 mt-3">Servico no encontrado</p>
                                </div>                                
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="servicio_delete.php" method="post">
