...
require_once "productos_delete.php"; ?>
        ...
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                <div class="row g-3 mb-3">
                    <div class="col">
                        <div class="card h-100" id="table" data-list='{"valueNames":["n","codigo","categoria","nombre","proveedor","stock","precio","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                                ...
                                <!-- <div class="row flex-between-center">
                                    ...
                                    <div class="col text-end pe-0">
                                        <div id="orders-actions">
                                            <a href="productos_add.php" class="btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ms-1">Agregar</span></a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                <a href="reporte_productos.php" target="_blank" class="me-1 btn btn-sm btn-outline border-300" type="button"><span class="bi bi-file-earmark-pdf-fill"></span><span class="d-none d-md-inline ms-1">Reporte</span></a>
                                                ...
                                                <a href="productos_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden align-middle">
                                        ...
                                        <tbody class="list">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td class="n"><?php echo $row["id_prod"]; ?></td>
                                                    <td class="foto"><?php if($row['foto']==null||file_exists("images/productos/".$row['foto'])==false){echo "<img class='rounded-2' src='images/productos/no-disponible.jpg' width='60px'>";} else {echo "<img class='rounded-2' src='images/productos/" . $row['foto'] . "' width='60px'>";}; ?></td>
                                                    <td class="codigo"><?php echo $row["codigo"]; ?></td>
                                                    <td class="categoria"><?php echo $row["nomcate"]; ?></td>
                                                    <td class="nombre"><?php echo $row["nompro"]; ?></td>
                                                    <td class="proveedor"><?php echo $row["nomprove"]; ?></td>
                                                    <td class="stock"><?php echo $row["stock"];
                                                                        if ($row['stock'] < 10) {
                                                                            echo '<span class=ms-1 p-1"><i class="text-warning fw-bold fas fa-exclamation-circle"></i></span>';
                                                                        }
                                                                        ?></td>
                                                    <td class="precio"><?php echo $row["precV"]; ?></td>
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="productos_edit.php?idproducto=<?php echo $row['id_prod']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#" data-id="<?php echo $row["id_prod"]; ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <p class="fw-bold fs-1 mt-3">Producto no encontrado</p>
                            </div>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="productos_delete.php" method="post">
