...
<head>
    <meta charset="UTF-8">
    <title>Reporte Veterinarios</title>
        ...
        <div>
            <table class="table table-striped table-borderless" style="margin: auto;font-size: 14px;">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td id="td"><?php echo $row["id_vet"]; ?></td>
                            <td id="td"><?php echo $row["dnivet"]; ?></td>
                            <td id="td"><?php echo $row["nomvet"] . " " . $row["apevet"]; ?></td>
                            <td id="td"><?php echo $row["correo"]; ?></td>
                            <td id="td"><?php echo $row["direcc"]; ?></td>
                            <td id="td"><?php echo $row["fijo"]; ?></td>
...
$dompdf->stream("reporte_veterinarios.pdf", array("Attachment" => false));
