    ...
    <main class="main" id="top">
        <div class="container" data-layout="container">
            ...
            <div class="content">
                ...
                $sql_raz = "SELECT raza.nomraza, raza.id_raza, pet_type.id_tiM, pet_type.noTiM, raza.estado FROM raza INNER JOIN pet_type ON raza.id_tiM = pet_type.id_tiM";
                $result_raz = mysqli_query($conex, $sql_raz);
                ?>
                <div class="row g-3 mb-3">
                    <div class="col">
                        <div class="card h-100" id="table" data-list='{"valueNames":["n","nombre","tipo","estado"],"page":5,"pagination":true,"fallback":"pages-table-fallback"}'>
                        <div class="card-header mt-3 ms-2">
                                <div class="row">
                                    <div class="col-12 align-self-center mb-3">
                                        <h5 class="mb-0">Lista Razas</h5>
                                    </div>
                                    <div class="col me-3 me-md-0 pe-0 my-2 mt-0">
                                        <div id="orders-actions" class="d-flex">
                                            ...
                                            <div class="ms-auto">
                                                ...
                                                <a href="raza_add.php" class="ms-1 btn btn-sm btn-outline border-300" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-md-inline ms-1">Agregar</span></a>
                                            </div>
                            ...
                            <div class="card-body px-0 pt-0">
                                    ...
                                    <table class="table table-striped fs--1 mb-0 overflow-hidden">
                                        ...
                                        <tbody class="list">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td class="n"><?php echo $row["id_raza"]; ?></td>
                                                    <td class="raza"><?php echo $row["nomraza"]; ?></td>
                                                    <td class="sexo"><?php echo $row["noTiM"]; ?></td>
                                                    <td class="estado" style="width: 8.5%;"><?php if ($row["estado"] == 1) {
                                                    ...
                                                    <td class="text-end">
                                                        <div>
                                                            <a href="raza_edit.php?idraza=<?php echo $row['id_raza']; ?>"><button class="btn p-0" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><span class="text-500 fas fa-edit"></span></button></a>
                                                            <a href="#"data-id="<?php echo $row["id_raza"];?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="$('#dataid').val($(this).data('id'));">
                                ...
                                <div class="text-center d-none mb-4" id="pages-table-fallback">
                                    <p class="fw-bold fs-1 mt-3">Raza no encontrada</p>
                                </div>                                
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="raza_delete.php" method="post">
